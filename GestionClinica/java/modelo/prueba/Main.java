...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n========================================");
		System.out.println("1. CREACIÓN DE MÉDICOS Y PACIENTES");
		System.out.println("========================================");
		...
		System.out.println("Habitación privada agregada al modelo.sistema");

		Habitacion habCompartida = new HabitacionCompartida(1500, 2);
		sistema.agregarHabitacion(habCompartida);
		System.out.println("Habitación compartida agregada al modelo.sistema");
...
//		Internación de p2
		...
		System.out.println("\n========================================");
		System.out.println("5. EGRESO Y FACTURACIÓN");
		System.out.println("========================================");
