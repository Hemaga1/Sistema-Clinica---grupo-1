    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            if (this.myAnchor != gridConstraints.myAnchor) {
                ...
                return false;
            } else if (!Objects.equals(this.myMaximumSize, gridConstraints.myMaximumSize)) {
                return false;
            } else if (!Objects.equals(this.myMinimumSize, gridConstraints.myMinimumSize)) {
                return false;
            } else if (!Objects.equals(this.myPreferredSize, gridConstraints.myPreferredSize)) {
                return false;
            } else if (this.myIndent != gridConstraints.myIndent) {
                return false;
            } else {
