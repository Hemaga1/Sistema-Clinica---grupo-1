...
public class FactoryPaciente {
	...
	public Paciente crearPaciente(String DNI, String nombre, String apellido, String domicilio, String ciudad, String telefono, int historiaClinica, String rangoEtario) {
